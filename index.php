		...
		<div class="services">
		    <section class="services">
		        <article>
		            ...
		            <dl>
		                <dt>Development</dt>
		                <dd>Site Selection</dd>
		                <dd>Master Planning</dd>
		                <dd>Zoning</dd>
		                <dd>Feasibility Analysis</dd>
		            </dl>
		            <dl>
		                <dt>Owners Representative</dt>
		                <dd>Budget Development</dd>
		                <dd>Constructability Reviews</dd>
		                <dd>Value Engineering</dd>
		                <dd>Cost Estimating</dd>
		                <dd>Scheduling</dd>
		                <dd>Sustainability</dd>
		                <dd>Bid Management</dd>
		                <dd>Procurement</dd>
		                <dd>Contract Development</dd>
